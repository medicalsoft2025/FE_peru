...
class StoreCreditNoteRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'detalles.*.mto_precio_unitario.required_without' => 'Debe especificar el precio unitario (con IGV) o el valor unitario (sin IGV).',
            'detalles.*.mto_precio_unitario.min' => 'El precio unitario debe ser mayor o igual a 0.',
            'detalles.*.mto_valor_unitario.required_without' => 'Debe especificar el precio unitario (con IGV) o el valor unitario (sin IGV).',
